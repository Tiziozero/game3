...
function M.init(self, owner, ref)
    ...
    self.desc = "test enemy does a whole bunch of stuff to figure out ho to do things"
    self.icon = "/home/kleidi/.tmp/HDjhNy5XAAAj08i?format=jpg.jpg"
